						...
						[
							...
							},
							{
								...
								[
									{
										type : 'html',
										html : '<div class="cke_dialog_ui_input_text"><input name="txtHref" id="txtHref" class="cke_dialog_ui_input_text" maxlength="150"  value="" type="text" /></div>',
										validate : function()
										{
							...
							},
							{
								...
								[
									{
										type : 'html',
										html : '<div class="cke_dialog_ui_input_text"><input name="txtCaption" id="txtCaption" class="cke_dialog_ui_input_text" maxlength="150" value="" type="text" /></div>'
									}
								]
							}
						]
					},
					{
						type : 'html',
							html : '<div><div id="message">Enter the first letters of the article title: </div>' +
									'<div onclick="jlinkDialog.hideSuggestions();" class="cke_dialog_ui_input_text"><input name="keyword" id="keyword" class="cke_dialog_ui_input_text" maxlength="150" value="" type="text" /></div></div>'
					},
					{
						type : 'hbox',
						children :
